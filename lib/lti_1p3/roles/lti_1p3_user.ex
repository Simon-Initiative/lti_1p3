...
defprotocol Lti_1p3.Roles.Lti_1p3_User do
  @doc """
  Returns all platform roles for a given user

  ## Examples
      iex> get_platform_roles(%Lti_1p3.Roles.Lti_1p3_User{})
      [%PlatformRole{}]
  """
  ...
  ## Examples
      iex> get_platform_roles(%Lti_1p3.Roles.Lti_1p3_User{}, "issuer-client_id-context_id")
      [%ContextRole{}]
  """
  def get_context_roles(user, context)
end

defimpl Lti_1p3.Roles.Lti_1p3_User, for: Any do
