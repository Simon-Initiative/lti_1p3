defmodule Lti_1p3.AuthorizationRedirect do
  ...
  """
  @spec authorize_redirect(params(), user(), binary(), binary()) :: {:ok, binary(), binary(), binary()} | {:error, %{optional(atom()) => any(), reason: atom(), msg: String.t()}}
