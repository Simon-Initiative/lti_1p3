...
For AGS APIs (claim parsing, line item CRUD, score posting, and results pagination), see [`docs/tool_ags_guide.md`](docs/tool_ags_guide.md).
For platform AGS APIs (authorization, line item CRUD, score ingestion, and results retrieval), see [`docs/platform_ags_guide.md`](docs/platform_ags_guide.md).
