defmodule Lti_1p3Test do
  ...
  describe "lti 1.3 library" do
    ...
    test "create and get valid registration", %{jwk: jwk} do
      ...
      assert get_registration_by_issuer_client_id("some issuer", "some client_id") == registration
    end

    test "create and get valid deployment", %{jwk: jwk} do
      {:ok, registration} = Lti_1p3.create_new_registration(%{
        issuer: "some issuer",
        client_id: "some client_id",
        key_set_url: "some key_set_url",
